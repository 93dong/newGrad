$(".navigation").load('data/left.php',function(){
	...
	var pageName=window.location.href.lastIndexOf('/');
	var selnav=path.slice(pageName+1,-5);
	switch(selnav){
		case "main" :
			$("li[data-name='main']").addClass("navsel");
			//绑定下拉函数
			...
			break;
		case "homePage" :$("li[data-name='homePage']").addClass("navsel");break;
		case "department" :$("li[data-name='department']").addClass("navsel");break;
